...
function Header(){
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <Link className="flex items-center" href="/" > <img src="https://t3.ftcdn.net/jpg/02/42/52/34/360_F_242523420_j2wQYgkRuWYRjLr2S6NcTOWyd5SghESH.jpg"  className="h-9 mr-7 " alt="Logo" />
    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PingPong</span></Link>
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <Link className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" href="/Home/Home">Home</Link>
        </li>
        <li>
